...
from .views.JobShortListView import jobshortlist_api as jobshortlist_blueprint
...
def create_app(env_name):
  ...
  app.register_blueprint(jobshortlist_blueprint, url_prefix='/api/v1/jobshortlists')
